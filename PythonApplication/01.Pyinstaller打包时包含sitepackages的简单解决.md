...
<img width="60%" height="auto" scr="https://img-blog.csdnimg.cn/34fdeba38046448d938d22d07e1de107.png?x-oss-process=image">

3. 另外如果发现将exe文件分享给其他人后，在其他电脑上不能运行并报ModuleNotFoundError时，可能是因为项目文件的引用格式不标准导致的。为此参考：

https://towardsdatascience.com/how-to-fix-modulenotfounderror-and-importerror-248ce5b69b1c

简单来说就是应该尽量避免使用sys.path，import平行路径下的module时，应写为import thisfolder.thismodule.py 即可。
